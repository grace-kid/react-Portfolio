    ...
    return (
       <div >
            ...
            <div className="landing-page h-160 p-5 rounded-3xl border-2 border-red-600" data-aos="fade-up" >
                ...
                <section className="about w-[50%]">
                </section>
            </div>
            <div className="absolute border-l-2 border-b-2 w-[43%] h-82 rounded-bl-sm right-8 top-21"  data-aos="flip-left"></div>
            <div className="bot absolute border-2 w-[41.3%] top-21 rounded-tl-sm rounded-tr-3xl rounded-br-sm rounded-bl-3xl right-8 h-76"  data-aos="flip-left">
            ...
            <div className="absolute top-117 w-[38.4%] p-5 border-r-2 border-t-2 h-64 rounded-tr-sm rounded-bl-sm" data-aos="fade-right"></div>
            <div className="h-58 border-2 rounded-bl-3xl rounded-tr-2xl myPic top-123 bg-red-700 absolute w-[36.8%]" data-aos="fade-right">
                <div>
                    <form action=""></form>
                </div>
            </div>
                    ...
                    <div className='m-0 z-0'>
                        <section className="section1 m-0 border-x-2 border-b-2 p-5 chakra-petch-light">
                            ...
                            <div className=" top-60  p-5 right-0 rounded-tl-3xl rounded-tr-sm rounded-br-3xl rounded-bl-sm hover:font-extrabold" data-aos="fade-left">
                               ...
                               <a href="src/assets/CV.docx" download={true}>
                               <button className="border-red-600 cvd text-2xl rounded-sm border-2 px-3 -skew-x-16 rounded-tr-xl rounded-br-xl                                hover:bg-red-950" data-aos="zoom-in" >Download CV<span><ion-icon  name="download"></ion-icon></span></button>
                               </a>
                            </div>
