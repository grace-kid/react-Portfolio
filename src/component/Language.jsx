      ...
      <div className="card text-amber-50 md:w-80">
        ...
        <ul className="card__list">
          ...
          <li className="card__list_item">
            ...
            <span className="list_text md:hover:scale-110">UI/UX</span>
          </li>
          {/* <li className="card__list_item">
            <span className="check">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="check_svg">
          ...
          <li className="card__list_item">
            ...
            <span className="list_text md:hover:scale-110">Next.js</span>
          </li>
         <li className="card__list_item">
            <span className="check">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="check_svg">
            ...
            <span className="list_text md:hover:scale-110">Python</span>
          </li>
          <li className="card__list_item">
            <span className="check">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="check_svg">
            ...
            <span className="list_text md:hover:scale-110">Django ninja</span>
          </li>
          ...
          <li className="card__list_item">
            ...
            <span className="list_text md:hover:scale-110">SQlite </span>
          </li>
